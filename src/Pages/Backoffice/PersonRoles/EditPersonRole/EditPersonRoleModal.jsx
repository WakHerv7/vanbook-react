...
import { updatePersonRole, selectPersonRoleById, selectAllPersonRoles,  getPersonRolesStatus, getPersonRolesError, fetchPersonRoles }from '../../../../Reducers/personRolesSlice';


function EditPersonRoleModal({personRoleId, handleModalOpen, modalOpen}) {
                        ...
                        <div className="flex mt-3 gap-10 w-full">
                            <div className="flex flex-col gap-5 w-full     014">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input type="text" value={personRoleName} onChange={(e)=>setPersonRoleName(e.target.value)} name="personRole_name" id="receiptNumInputId" className="outline-none py-2 px-2 rounded-md border border-[#41436a]" placeholder='...'/>
                                </div>                                                               
                            </div>                            
                        </div>
...
export default EditPersonRoleModal;