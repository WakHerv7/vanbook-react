...
import { addNewAccount, selectAllAccounts,  getAccountsStatus, getAccountsError, fetchAccounts }from '../../../../Reducers/accountsSlice';
...
function AddAccountModal({handleModalOpen, modalOpen}) {
                    ...
                    <div className="new_account_modal_page_2">
                        ...
                        <div className="flex mt-3 gap-10">
                            ...
                            <div className="flex flex-col gap-5">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input type="number" onChange={(e)=>setAccountNumber(e.target.value)} name="account_name" id="receiptNumInputId" className="outline-none py-2 px-2 rounded-md border border-[#41436a]" placeholder='...'/>
                                </div>
                            </div>                            
                        </div>
                        <div className="flex w-full my-5">
                            <div className="flex w-full flex-col gap-1">
                                ...
                                <textarea name="" id="" rows="5" onChange={(e)=>setAccountDescription(e.target.value)} className={`border border-[#41436a] rounded-md`}>
