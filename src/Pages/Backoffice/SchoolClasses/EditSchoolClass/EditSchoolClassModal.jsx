...
import { updateSchoolClass, selectSchoolClassById, selectAllSchoolClasses,  getSchoolClassesStatus, getSchoolClassesError, fetchSchoolClasses }from '../../../../Reducers/schoolClassesSlice';


function EditSchoolClassModal({schoolClassId, handleModalOpen, modalOpen}) {
...
export default EditSchoolClassModal;