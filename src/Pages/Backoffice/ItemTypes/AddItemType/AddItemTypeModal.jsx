...
import { addNewItemType, selectAllItemTypes,  getItemTypesStatus, getItemTypesError, fetchItemTypes }from '../../../../Reducers/itemTypesSlice';


function AddItemTypeModal({handleModalOpen, modalOpen}) {
                        ...
                        <div className="flex mt-3 gap-10 w-full">
                            <div className="flex flex-col gap-5 w-full">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input type="text" onChange={(e)=>setItemTypeName(e.target.value)} name="itemType_name" id="receiptNumInputId" className="outline-none py-2 px-2 rounded-md border border-[#41436a]" placeholder='...'/>
                                </div>                                
                            </div>                            
                        </div>
