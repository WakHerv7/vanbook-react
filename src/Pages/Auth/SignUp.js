      ...
      <div className='w-[65%] border mx-auto flex my-8 rounded'>
        ...
        <div className='flex-1 bg-[#FAF0CA] p-8 text-[#2E2F5B]'>
          <div className='pt-[4rem]'>
            ...
            <p className='mt-4 text-[.9rem]'>* If you have an existing QuickBooks Online account, you can add / sign up for a new company using your existing sign in details. This single sign in allows you to view and manage multiple companies, including your existing account.</p>
          </div>
