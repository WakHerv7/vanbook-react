...
import payment from '../../../Assets/payment-info.png'
import spreadsheet from '../../../Assets/spreadsheet.png'
import investor from '../../../Assets/investor-presentation.png'
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.cardContainer}>
                <Card display={display} image={invoice} text='Send and track invoices' />
                <Card display={display} image={research} text='Organize your expenses' />
                <Card display={display} image={accountant} text='Track your sales tax' />
                <Card display={display} image={employee} text="Track your retail sales" />
            </div>
